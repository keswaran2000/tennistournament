let worldTournament = [
  ...
  console.table(worldTournament);
  
  function schedulingMatches() {
    let tournamentSchedule = [];
    for (i = 0; i < worldTournament.length / 2; i++) {
      let Schedule = {
  ...
  function roundOneMatches() {
    ...
    for (sum = 0; sum < round_One.length; sum += 2) {
      let round_1 = {
  ...
  function roundTwoMatches() {
    ...
    for (l = 0; l < round_Two.length; l += 2) {
      let round_2 = {
  ...
  function roundThreeMatches() {
    let roundThreeSchedule = [];
    let round_Three = roundThree();
    for (n = 0; n < round_Three.length; n += 2) {
      let round_3 = {
  ...
  //----TOTALMATCHES
  function wholeTournamentSchedule() {
